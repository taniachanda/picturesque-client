...
const Login = () => {
	...
	return (
		...
		<form onSubmit={handleSignIn} style={{ maxWidth: '400px', backgroundColor:'#fff' }} className='mx-auto m-4 p-4 shadow-lg rounded'>
			...
			<input type="text" className='form-control my-3 px-1' onBlur={handleBlur} name="email" id="usermail" placeholder='Email address' autoComplete="username" required />
			<input type="password" className='form-control my-3 px-1' onBlur={handleBlur} name="password" id="userpass"  autoComplete="current-password" placeholder='Choose password' required />
			{
